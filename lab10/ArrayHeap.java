...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    private void swim(int index) {
        ...
        /** TODO: Your code here. */
        while (index == min(index, parentIndex(index)) && index != 1) {
    ...
    private void sink(int index) {
        ...
        /** TODO: Your code here. */
        while (leftIndex(index) == min(index, leftIndex(index))
                || rightIndex(index) == min(index, rightIndex(index))) {
...
=======
>>>>>>> 436ad30267834956b92f46d82b08dfa4abe0d6c4
        T smallest = peek();
